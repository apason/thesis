...
\begin{lemma}[] ~\label{overlap-length}
...
sitten kun tarkastellaan samaa tilannetta niin että edellisen lemman s onkin jokin keywordi

tästä päästään teoreemaan jota ei tarvitse todistaa

\begin{theorem} ~\label{thm-maximal-overlap}
