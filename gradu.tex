...
we show the time portion of our implementations (DIE for cere and RBD for \texttt{einstein.en.txt})
that were
...
lengths of 128 and 254 were investigated. This experiment was run in Haapa. For the Dna dataset,
...
Table \ref{tbl-graphs}


% käydään läpi taulukot
% -> meidän on parempi kuin ref samalla pituudella instanssin kasvaessa

% Todetaan että tämä on kuitenkin päinvastoin kun instanssin koko pysyy samana mutta pituus kasvaa.
...
\begin{center}
  ...
  \begin{tabular} {|l|r r r|r r r|l|}
    \hline
     ...
     \textbf{\#} & \textbf{Reference} & ~~~~\textbf{DIE} & \textbf{Percentage}  &~~~~\textbf{Reference} & ~~~~\textbf{FIE} & \textbf{Percentage} & ~~~~\textbf{-Comp.} \\
     \hline
     ...
     9 & 167.34          & \textbf{102.38} & 61.6   & 107.72         & 51.92           & \textbf{48.2}   & 0.254 \\
...
\begin{center}
  ...
  \caption{The number of factors in relative Lempel-Ziv compression. The upper numbers result when
    the RLZ dictionary is a common superstring of the corresponding file. The lower numbers result
    when the dictionary is a string obtained by concatenating random samples of the file with
    parameters specified in the column title. Both dictionaries have the same length.}
