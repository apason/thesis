...
\hspace{-1.7cm}
 ...
 SCS & defined / undefined & undefined & Calculates the common superstring if defined.  \\
...
\section{Results}
For each result in this section, the binaries that are used are compiled with the same compiler
with same optimization flags (gcc, -O3, -flto)
