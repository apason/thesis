...
% joo katotaan nyt näit ärlz hommia

% ajettiin tämmönen testi mistä saatiin tämmönen tauluko
% -> selkeesti vähemmän factoreita kun käytetään superstringiä.

% palataan takasin pizzachili taulukoihin. Näissä näytetään kompressio sekä rzsise. Kerrotaan mitä nää on.
% Nyt todetaan että pakkauksen koko on huomattavasti pienempi SCS:llä.
