...
As we see, the maximum time portion for the cere files is 1.06\% of the total runtime. The results
were similar for all instances with a small ($\leq 12$} alphabets. Based on this data, it is reasonable
to say that the preprocessing time of the program is insignificant for instances with a small alphabet.
  
  


todetaan että oikeesti nlogn aina mutta näytetään aikameininki ja todetaan että näillä inputeilla
nlogn voidaan jättää huomiotta.
