...
%- hampath
%- longest hampath
%- longest hampath problem


%% longest hamiltonian path problem!
%% graph
%% digraph
%% weighted graph (weight function)
...
%   [scale=.8]
  ...
  \end{tikzpicture}
  \caption{Fully constructed AC-machine for the keywords $R=\{$"baa", "baba", "abab", "aab"$\}$. TODO: arrow heads to node 1.} \label{fig-ac}
\end{figure}
