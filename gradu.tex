...
\begin{table}
\hskip-1.5cm\resizebox{1.1\columnwidth}{!}{%
  \begin{tabular}{c c}
...
\begin{minipage}{.5\textwidth}
  \begin{tikzpicture}
    \begin{axis}[
		ylabel=c) \texttt{einstein.de.txt},
		xlabel=,
                xmax=100,
                xmin=0,
                xtick={5, 50, 95},
...
\begin{tikzpicture}
	...
	\end{axis}
        \begin{axis}[
            xlabel=,
            ylabel=d) \texttt{einstein.en.txt},
            xmax=100,
            xmin=0,
            xtick={5, 50, 95},
            xticklabels={,,},
