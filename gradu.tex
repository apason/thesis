...
https://gradcoach.com/dissertation-conclusion-chapter/
...
- scs can be implemented relatively quickly
- scs does decrease the sizes of the rlz dictionaries


Inform the reader of the study’s main contributions
- open source implementation of Ukkonen's algorithm
- answer to the rlz hypothesis

Discuss any limitations or weaknesses of the study
- insufficient memory comparison on measurements.
- high memory consumption 

Present recommendations for future research
- runtime and memory measurements with full rlz compression with / without scs
- 
